                ...
                if (enterAmount1.length() > 0 && pinNumber.length() > 0) {
                    try {
                        ...
                        if (rs2.next()) {
                            ...
                            double totalAmount = enterAmount + availableAmount;
                            ...
                            String newQuery2 = "insert into transaction values('Amount Deposited'," + enterAmount + ",'" + myDate + "'," + totalAmount + ",'" + userName + "',"+pinNumber+");";
                            int execute2 = conn.s.executeUpdate(newQuery2);
                            System.out.println(execute2 + " row/s affected");

                            JOptionPane.showMessageDialog(null, "Amount Deposited Successfully", "Message", JOptionPane.PLAIN_MESSAGE);
                        } else {
